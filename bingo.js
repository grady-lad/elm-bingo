...
var _user$project$Bingo$viewPlayer = F2(
	function (name, gameNumber) {
		var playInfoText = _elm_lang$html$Html$text(
...
var _user$project$Bingo$initialModel = {name: 'Martin', gameNumber: 1, entries: _user$project$Bingo$initialEntries};
...
var _user$project$Bingo$viewEntryItem = function (entryItem) {
	return A2(
		_elm_lang$html$Html$li,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'marked', _1: entryItem.marked},
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Bingo$Mark(entryItem.id)),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(entryItem.phrase),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(entryItem.points)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Bingo$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Bingo$viewHeader('BUZZWORD BING'),
			_1: {
				ctor: '::',
